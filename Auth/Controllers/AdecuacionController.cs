...
namespace Auth.Controllers
{
    public class AdecuacionController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CodAdecuacion,DesAdecuacion,Activo")] Adecuacion adecuacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CodAdecuacion,DesAdecuacion,Activo")] Adecuacion adecuacion)
        {
            if (ModelState.IsValid)
            {
