...
<body style="font-family: Segoe UI, Verdana, Helvetica, Sans-Serif; font-size: small">
    <form id="form1" runat="server">
        ...
        <h4 style="text-align: left"><b>Registro de Usuario</b></h4>
        <hr />
        <div>
            <h4 style="text-align: left">Usuario</h4>
            <asp:Label runat="server" AssociatedControlID="UserName" autocomplete="off"></asp:Label>
            <asp:TextBox runat="server" ID="UserName"></asp:TextBox>
        </div>
        <div>
            <h4 style="text-align: left">Contraseña</h4>
            <asp:Label runat="server" Style="text-align: center" AssociatedControlID="Password" autocomplete="off"></asp:Label>
